namespace MduiBlazor.Utilities
{
    ...
    public struct ClassBuilder(string value)
    {
        ...
        /// </summary>
        /// <param name="value"></param>
        public static ClassBuilder Default(string value) => new(value);
        ...
        /// <returns>CssBuilder</returns>
        public ClassBuilder AddClass(string? value) => !string.IsNullOrWhiteSpace(value) ? AddValue(" " + value) : this;
        ...
        /// <returns>CssBuilder</returns>
        public ClassBuilder AddClass(string? value, bool when = true) => when ? AddClass(value) : this;
        ...
        /// <returns>CssBuilder</returns>
        public ClassBuilder AddClass(string value, bool? when = true) => when == true ? AddClass(value) : this;
        ...
        /// <param name="when">Condition in which the CSS Class is added.</param>
        /// <returns>CssBuilder</returns>
        public ClassBuilder AddClass(string value, Func<bool>? when = null) => AddClass(value, when != null && when());
        ...
        /// <param name="when">Condition in which the CSS Class is added.</param>
        /// <returns>CssBuilder</returns>
        public ClassBuilder AddClass(Func<string> value, bool when = true) => when ? AddClass(value()) : this;
        ...
        /// <param name="when">Condition in which the CSS Class is added.</param>
        /// <returns>CssBuilder</returns>
        public ClassBuilder AddClass(Func<string> value, Func<bool>? when = null) => AddClass(value, when != null && when());
        ...
        /// <param name="when">Condition in which the CSS Class is added.</param>
        /// <returns>CssBuilder</returns>
        public ClassBuilder AddClass(ClassBuilder builder, bool when = true) => when ? AddClass(builder.Build()) : this;
        ...
        /// <param name="when">Condition in which the CSS Class is added.</param>
        /// <returns>CssBuilder</returns>
        public ClassBuilder AddClass(ClassBuilder builder, Func<bool>? when = null) => AddClass(builder, when != null && when());
